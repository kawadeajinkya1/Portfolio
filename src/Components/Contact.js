      ...
      <div className='cnt'>
        <div className='cnt1'>
          <Fade left>
            ...
            <form action="https://formsubmit.co/ajinkyak192.com" method="POST" id='form'>
              <input placeholder='ENTER YOUR NAME' className='I1' name='name' id='name' type="text" required /><br />
              <input placeholder='ENTER MOBILE NO'minLength={10} maxLength={10} className='I1' name='phn' pattern="[0-9]{10}" id='phn' type="text" required /><br />
